...
class setting extends CI_Controller {
    ...
    public function index(){
                 ...
                 if($this->core->checkPermissions('setting','edit')){
                     ...
                     $store = array(
                            ...
                            14 => array(
                                ...
                                'value'     => $this->input->post('lang',true)
                                )
                            );
                    ...
                    $data['CONTENT'] = 'msg';
                    $data['TITLE'] = $this->lang->line('setting_index');
                    $data['MSG'] = $this->lang->line('setting_save_data_correctly') .  anchor(base_url().'setting', $this->lang->line('setting_back_to_setting'));
                }else
        ...
        $data['NAV'] = array(
            ...
            base_url().'setting'   => $this->lang->line('setting_index'),
        );
